...
<form:form action="brotherhood/brotherhood/edit.do"
	...
	<br />
	<spring:message code="brotherhood.leave.explanation"
	...
	<input type="submit" name="save"
		value="<spring:message code="brotherhood.edit.save.save" />" />&nbsp;
	<input type="submit" name="leave"
		value="<spring:message code="brotherhood.edit.leave" />"
