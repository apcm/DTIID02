...
<title><spring:message code="legalRecord.create" /></title>
</head>
<body>
	<form:form modelAttribute="legalRecord" action="legalrecord/brotherhood/edit.do">
		...
		<acme:textbox code="record.legalName" path="legalName"/>
		<br>
		<br>
		
		<acme:textbox code="record.applicableLaws" path="applicableLaws"/>
		<br>
		<br>

		<acme:textbox code="record.vatNumber" path="vatNumber"/>
		<br>
		<br>
	...
	<input type="button" name="cancel"
		...
		onclick="javascript: relativeRedir('/history/brotherhood/showHistory.do');" />
</form:form>
