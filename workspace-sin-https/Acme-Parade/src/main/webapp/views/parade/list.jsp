...
<display:table pagesize="5" class="displaytag" keepStatus="true"
	...
	<jstl:if test="${row.finalMode == false}">
		<display:column property="title" titleKey="parade.title" style="background-color:lightorange;"/>
		<display:column property="description" titleKey="parade.description" style="background-color:lightorange;"/>
		<display:column property="brotherhood.title"
		...
		<display:column property="ticker" titleKey="parade.ticker" style="background-color:lightorange;"/>
		<display:column property="finalMode" titleKey="parade.finalMode" style="background-color:lightorange;"/>
	...
	<display:column>	
			...
			<a href="parade/chapter/editStatus.do?paradeId=${row.id}">
